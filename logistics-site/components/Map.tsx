  ...
  return (
    <div className="relative w-full h-[500px] rounded-lg overflow-hidden shadow-lg">
      ...
      <button
        ...
        disabled={isLocating}
        className="absolute top-4 right-4 z-[1000] bg-white hover:bg-gray-100 text-gray-700 font-semibold py-2 px-4 rounded-lg shadow-lg transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {/* Сообщение об ошибке */}
      {locationError && (
        <div className="absolute bottom-4 left-4 right-4 z-[1000] bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg shadow-lg">
